 ...
 */
Blaze.View.prototype.subscribe = function (/* arguments */) {
  var self = this;
  ...
  if (Tracker.active) {
    throw new Error("Can't call View#subscribe from a Tracker Computation; try calling it from the created or rendered callback");
  }
